...
namespace Scobby.Migrations
{
    ...
    public partial class FirstdMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserBeltResponses",
                columns: table => new
                {
                    UserBeltResponseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "varchar(60)", maxLength: 60, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBeltResponses", x => x.UserBeltResponseId);
                    table.ForeignKey(
                        name: "FK_UserBeltResponses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBeltResponses_UserId",
                table: "UserBeltResponses",
                column: "UserId");
        }
